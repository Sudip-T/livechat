...
from .serializers import MyTokenObtainPairSerializer, RegisterSerializer, TodoSerializer, MessageSerializer, ProfileSerializer,UserSerializer
...
def mymessage(request):
    ...
    return render(request, 'mymessage.html', {'messages': messages})